function StringConstants() {
  ...
  return {
    MICROSOFT_SIGNIN, SIMPLIFY_STATUS, MARK_YOUR_ATTENDANCE, SIGN_IN_WITH_APCONIC_ACCOUNT, UNKNOWN, PRESENT, ON_LEAVE, ON_LEAVE_FROM, OUTSIDE, OUTSIDE_FROM, STATUS_UPDATED_AT, EMAIL, NAME, EMPLOYEES, MOBILE_NO, STATUS, LASTOUTSIDEDOC, EMPLOYEE_ID , STATUSLOG
  }
}
